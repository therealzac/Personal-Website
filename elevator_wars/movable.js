...
Movable.prototype.wait = function(millis, cb) {
    ...
    var timeSpent = 0.0;
    var self = this;
    self.currentTask = function waitTask(timeSinceUpdate) {
        timeSpent += timeSinceUpdate;
        if (timeSpent > millis) {
...
Movable.prototype.moveToOverTime = function(newX, newY, timeToSpend, interpolator, cb) {
    ...
    var timeSpent = 0.0;
    var self = this;
    self.currentTask = function moveToOverTimeTask(timeSinceUpdate) {
        timeSpent = Math.min(timeToSpend, timeSpent + timeSinceUpdate);
...
Movable.prototype.update = function(timeSinceUpdate) {
    if (this.currentTask !== null) {
        this.currentTask(timeSinceUpdate);
    }
};
